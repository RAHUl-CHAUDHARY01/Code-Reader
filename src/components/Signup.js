...
const Signup = (props) => {
    ...
    const handleSubmit = async (e) => {
        ...
        // const response = await fetch("http://localhost:5000/api/auth/createuser", {
          const response = await fetch("https://codereaderbackend.onrender.com/api/auth/createuser", {
    ...
    return (
      ...
      <LoginBox style={{height:"550px"}}>
        <LoginBoxHeading>Sign Up</LoginBoxHeading>
        <form  onSubmit={handleSubmit}>
        <UserBox>
            {/* <label htmlFor=""></label> */}
            <label>Username</label>
            {/* <UserBoxInput type="text" name="" required /> */}
            <UserBoxInput  type="text"  value={credentials.name} onChange={onChange} id="name" name="name" aria-describedby="emailHelp" />
          </UserBox>
          <UserBox>
            {/* <label htmlFor=""></label> */}
        ...
        <UserBoxInput type="password" value={credentials.cpassword} onChange={onChange} name="cpassword" id="cpassword" />

          </UserBox>
          <LoginButtonHover type="submit" onSubmit={handleSubmit} style={{position:"relative",left:"90px",bottom:"50px"}}>
            <ButtonSpan1 />
            <ButtonSpan2 />
            <ButtonSpan3 />
            {/* <ButtonSpan4 /> */}
            <button type="submit"  style={{ border:" none", /* remove border */
  background: "transparent", color:"#b79726"}}>SIGN UP</button>
            {/* Submit */}
            {/* submit */}
          </LoginButtonHover>
        </form>
